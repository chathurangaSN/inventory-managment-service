...
insert into DraftDetails (brandId, OSid, itemId, quantity, uomId) values (2, 1, 1, 24, 2)
...
insert into TransactionLog (date, type, userId) values ("2019-02-01 09:00:00", "issue", 1)
